...
<div class="row">
    ...
    <div class="col-sm-6 text-right btn-toolbar">
        <?php foreach($buttons as $button){
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_CREATE)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_DELETE)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_SAVE)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_CANCEL)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_BACK)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_REDIRECT)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_SUBMIT)
            {
                $button['label'] = !isset($button['label'])?trans('Custom'):$button['label'];
                ?>
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_UPLOAD)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_PUBLISH)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_UNPUBLISH)
            {
            ...
            if($button['type'] == \Doanthuan\Ladmin\Html\Toolbar::BUTTON_CLICK)
            {
