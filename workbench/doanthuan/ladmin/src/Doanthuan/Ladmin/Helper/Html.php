...
namespace Doanthuan\Ladmin\Helper;
...
class Html {
    ...
    public static function gridPublish($value, $i, $col = 'status')
    {
        $status = $value == 1 ? 'publish' : 'unpublish';
        $value = $value == 1 ? 0 : 1;
        $task = 'publish';
        $href = '
		<a href="#" onclick="return publishItem(\'cb' . $i . '\',\'' . $value . '\',\'' . $col . '\')" >
...
//            }
    ...
    public static function paginateLimitBox()
    {
        ...
        $html = \Doanthuan\Ladmin\Helper\Html::dropdown('limit', $value, $attributes,
            $data, null, null, null
        );
        return $html;
    }
