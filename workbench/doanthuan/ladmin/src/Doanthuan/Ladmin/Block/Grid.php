<?php
namespace Doanthuan\Ladmin\Block;
...
class Grid extends BaseBlock{
    ...
    public function getActionLinks($item, $i)
    {
       ...
       // $editLink = '<a href="'.$editUrl.'?id='.$item->getKey().'">'.trans('Edit').'</a>';
        ...
        $editLink = '<a class="btn btn-sm btn-info" href="'.$editUrl.'?id='.$keyValue.'"><i class="fa fa-pencil-square-o"></i></a>';
        return $editLink;
    }
...
//                        }
    ...
    {
//        if($query instanceof \Doanthuan\Ladmin\Model\ModelList)
//        {
...
//        }
        ...
        $defaultPageSize = 20;
        $pageSize = Request::input('limit', $defaultPageSize);
